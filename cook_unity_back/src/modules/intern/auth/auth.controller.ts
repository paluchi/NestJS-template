...
@ApiTags('Interns auth')
@Controller(PATH_PREFIX)
export class AuthController {
  constructor(private readonly authService: AuthService) {}

  @ApiCreatedResponse({ description: 'Successfully registered a new intern' })
  @ApiConflictResponse({
    description: 'Username already taken',
  })
  @ApiOperation({ summary: 'Register as a chef' })
  @Post('register')
  ...
  @ApiOperation({ summary: 'Login as a chef' })
  @Post('login')
